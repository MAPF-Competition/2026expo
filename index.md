...
<div class="sponsor-logos" aria-label="Participating institutions and sponsor">
  <span class="sponsor-logo"><img src="{{ '/resources/logos/mit_logo.png' | relative_url }}" alt="Massachusetts Institute of Technology"></span>
  <span class="sponsor-logo"><img src="{{ '/resources/logos/monash_logo.png' | relative_url }}" alt="Monash University"></span>
  <span class="sponsor-logo"><img src="{{ '/resources/logos/rutgers_logo.png' | relative_url }}" alt="Rutgers University"></span>
  <span class="sponsor-logo"><img src="{{ '/resources/logos/uci-logo.jpg' | relative_url }}" alt="University of California, Irvine"></span>
  <span class="sponsor-logo"><img src="{{ '/resources/logos/amazon_robotics_logo.png' | relative_url }}" alt="Amazon Robotics"></span>
</div>
