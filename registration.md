...
Joining instructions will be provided to registered attendees. Please check the [invited speakers page]({{ '/invited_speaker/' | relative_url }}) and [program page]({{ '/schedule/' | relative_url }}) for updates. More speaker details are coming soon.
